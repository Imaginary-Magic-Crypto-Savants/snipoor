        ...
        <>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", minHeight: 0 }}>
            ...
            <div style={{ display: activeTab === "wallets" ? "flex" : "none", flexDirection: "column", flex: 1, minHeight: 0 }}>
              <WalletsPanel wallets={wallets} ethPriceUsd={ethPriceUsd} balanceLoading={balanceLoading} balanceFetchedAt={balanceFetchedAt} onCopy={(msg) => toast.show(msg)} onRefresh={refresh} onRefreshBalances={handleRefreshBalances} onWalletAllowanceChange={setWalletAllowance} />
            </div>
